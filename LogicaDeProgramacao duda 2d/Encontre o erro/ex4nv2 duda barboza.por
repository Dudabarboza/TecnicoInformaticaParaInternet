...
programa
{
	...
	funcao inicio()
	{
		...
		se(salario > 400){
			...
			aumento = salario - s30
			escreva("Salário R$ ",salario," com aumento de R$ ",s30," e o salário com bônus: ",aumento)
		} senao se (salario >= 300 e salario <= 400){
			s25 = mat.arredondar((salario * 0.25), 2)
			aumento = salario - s25
			escreva("Salário R$ ",salario," com aumento de R$ ",s25," e o salário com bônus: ",aumento)
		} senao se (salario >= 200 e salario <= 300){
			s20 = mat.arredondar((salario * 0.2), 2)
			aumento = salario - s20
			escreva("Salário R$ ",salario," com aumento de R$ ",s20," e o salário com bônus: ",aumento)
		} senao se (salario <= 200){
			s10 = mat.arredondar((salario * 0.1), 2)
			aumento = salario + s10
			escreva("Salário R$ ",salario," com aumento de R$ ",s10," e o salário com bônus: ",aumento)
		}
	}
}
/* $$$ Portugol Studio $$$ 
