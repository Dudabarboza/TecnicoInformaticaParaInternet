...
programa
{
	...
	funcao inicio()
	{
		...
		se(mediaPonderada <=10.0 e mediaPonderada > 8.0){
			escreva("\nVocê tirou A")
				
		}senao se(mediaPonderada >= 7.0 e mediaPonderada <=8.0){
			escreva("\nVocê tirou B")
		}senao se(mediaPonderada >= 6.0 e mediaPonderada <= 7.0){
			escreva("\nVocê tirou C")
		}senao se(mediaPonderada >= 5.0 e mediaPonderada <= 6.0){
			escreva("\nVocê tirou D")
		}senao{
			escreva("\nVocê tirou E")
		}
